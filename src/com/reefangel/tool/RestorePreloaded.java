...
public class RestorePreloaded implements Tool {
	...
	public void run() {
		...
		if (result == JOptionPane.YES_OPTION) {
			...
			if (editor.status.message == "Done uploading.")
				JOptionPane.showMessageDialog(null,new JLabel("<html>Your Reef Angel Controller has been restored.</html>") , "Reef Angel Controller", JOptionPane.INFORMATION_MESSAGE);
			else
	...
	private void ShowStep2()
	{
		...
		steps.setFont(new Font("Arial", Font.BOLD, 24));
		panel2.add(steps);
		JLabel text = new JLabel("<HTML><br>Arduino is now compiling your sketch.<br>In a few seconds, it will start uploading the code to your Reef Angel Controller.<br>When the upload process completes, your Reef Angel Controller will have<br>the same pre-loaded code that was originally shipped with your controller.<br><br>Please wait...<br><br></HTML>");
		panel2.add(text);
		panel.add(panel2);
		
		JOptionPane pane = new JOptionPane(panel);
		pane.setOptions(new Object[] {});
		dialog = pane.createDialog(editor,"Step2"); 
